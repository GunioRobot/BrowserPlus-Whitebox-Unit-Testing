...
module RbConfig
  ...
  CONFIG["configure_args"] = " '--enable-shared' '--prefix=/Users/ndmanvar/Desktop/rubyinterpreter/bp-ruby/external/dist' '--disable-install-doc' '--without-openssl' '--disable-openssl' '--without-zlib' '--disable-zlib' 'CC=gcc-4.0' 'CXX=g++-4.0'"
  ...
  CONFIG["LDFLAGS"] = "-L. "
  CONFIG["CFLAGS"] = " $(cflags)  -fno-common -pipe -fno-common"
  CONFIG["CC"] = "gcc-4.0"
