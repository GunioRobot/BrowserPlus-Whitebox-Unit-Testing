...
module RbConfig
  ...
  TOPDIR = File.dirname(__FILE__).chomp!("/lib/ruby/1.9.1/i386-darwin10.4.0")
  DESTDIR = '' unless defined? DESTDIR
  CONFIG = {}
  CONFIG["DESTDIR"] = DESTDIR
  CONFIG["INSTALL"] = '/usr/bin/install -c'
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/Users/ndmanvar/Desktop/rubyinterpreter/bp-ruby/external/dist")
  ...
  CONFIG["configure_args"] = " '--enable-shared' '--prefix=/Users/ndmanvar/Desktop/rubyinterpreter/bp-ruby/external/dist' '--disable-install-doc' '--without-openssl' '--disable-openssl' '--without-zlib' '--disable-zlib' 'CC=gcc-4.0' 'CFLAGS=-g -O0 ' 'CXX=g++-4.0'"
  ...
  CONFIG["sitearch"] = "i386-darwin10.4.0"
  CONFIG["arch"] = "i386-darwin10.4.0"
  ...
  CONFIG["LIBRUBY_LDSHARED"] = "gcc-4.0 -dynamiclib -undefined suppress -flat_namespace"
  ...
  CONFIG["DLEXT2"] = ""
  CONFIG["DLEXT"] = "bundle"
  CONFIG["LDSHAREDXX"] = "g++-4.0 -dynamic -bundle -undefined suppress -flat_namespace"
  CONFIG["LDSHARED"] = "gcc-4.0 -dynamic -bundle -undefined suppress -flat_namespace"
